...
newhousehold_power_consumption$Voltage<- as.numeric(as.character(newhousehold_power_consumption$Voltage))
newhousehold_power_consumption$Global_reactive_power<- as.numeric(as.character(newhousehold_power_consumption$Global_reactive_power))
...
par(mfrow=c(2,2))
with(newhousehold_power_consumption, plot(x, Global_active_power, type="l", ylab="Global Active Power", xlab = ""))

with(newhousehold_power_consumption, plot(x, Voltage, type="l", ylab="Voltage", xlab = "datetime"))
...
with(newhousehold_power_consumption, plot(x, Global_reactive_power, type="l", xlab = "datetime"))
